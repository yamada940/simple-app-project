 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ua=new fo("@firebase/app-compat"),zg="@firebase/app-compat",Hg="0.2.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */if(gd()&&self.firebase!==void 0){Ua.warn(`
  ...
  `);const t=self.firebase.SDK_VERSION;t&&t.indexOf("LITE")>=0&&Ua.warn(`
    ...
    `)}const vo=Gg;Kg();var Wg="firebase",Qg="9.15.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,Nr.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Hi(q.min(),i,eh(),lt(),Q())}}class Nr{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new Nr(r,n,Q(),Q(),Q())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class py{constructor(e,n,r,i){this.remoteDocumentCache=e,this.mutationQueue=n,this.documentOverlayCache=r,this.indexManager=i}getDocument(e,n){let r=null;return this.documentOverlayCache.getOverlay(e,n).next(i=>(r=i,this.remoteDocumentCache.getEntry(e,n))).next(i=>(r!==null&&Vn(r.mutation,i,Ke.empty(),me.now()),i))}getDocuments(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.getLocalViewOfDocuments(e,r,Q()).next(()=>r))}getLocalViewOfDocuments(e,n,r=Q()){const i=xt();return this.populateOverlays(e,i,n).next(()=>this.computeViews(e,n,i,r).next(s=>{let o=kn();return s.forEach((a,u)=>{o=o.insert(a,u.overlayedDocument)}),o}))}getOverlayedDocuments(e,n){const r=xt();return this.populateOverlays(e,r,n).next(()=>this.computeViews(e,n,r,Q()))}populateOverlays(e,n,r){const i=[];return r.forEach(s=>{n.has(s)||i.push(s)}),this.documentOverlayCache.getOverlays(e,i).next(s=>{s.forEach((o,a)=>{n.set(o,a)})})}computeViews(e,n,r,i){let s=lt();const o=Un(),a=Un();return n.forEach((u,c)=>{const l=r.get(c.key);i.has(c.key)&&(l===void 0||l.mutation instanceof Ht)?s=s.insert(c.key,c):l!==void 0&&(o.set(c.key,l.mutation.getFieldMask()),Vn(l.mutation,c,l.mutation.getFieldMask(),me.now()))}),this.recalculateAndSaveOverlays(e,s).next(u=>(u.forEach((c,l)=>o.set(c,l)),n.forEach((c,l)=>{var h;return a.set(c,new my(l,(h=o.get(c))!==null&&h!==void 0?h:null))}),a))}recalculateAndSaveOverlays(e,n){const r=Un();let i=new ye((o,a)=>o-a),s=Q();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,n).next(o=>{for(const a of o)a.keys().forEach(u=>{const c=n.get(u);if(c===null)return;let l=r.get(u)||Ke.empty();l=a.applyToLocalView(c,l),r.set(u,l);const h=(i.get(a.batchId)||Q()).add(u);i=i.insert(a.batchId,h)})}).next(()=>{const o=[],a=i.getReverseIterator();for(;a.hasNext();){const u=a.getNext(),c=u.key,l=u.value,h=Zl();l.forEach(f=>{if(!s.has(f)){const d=Kl(n.get(f),r.get(f));d!==null&&h.set(f,d),s=s.add(f)}}),o.push(this.documentOverlayCache.saveOverlays(e,c,h))}return E.waitFor(o)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,n){return this.remoteDocumentCache.getEntries(e,n).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,n,r){return function(i){return O.isDocumentKey(i.path)&&i.collectionGroup===null&&i.filters.length===0}(n)?this.getDocumentsMatchingDocumentQuery(e,n.path):Vl(n)?this.getDocumentsMatchingCollectionGroupQuery(e,n,r):this.getDocumentsMatchingCollectionQuery(e,n,r)}getNextDocuments(e,n,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,n,r,i).next(s=>{const o=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,n,r.largestBatchId,i-s.size):E.resolve(xt());let a=-1,u=s;return o.next(c=>E.forEach(c,(l,h)=>(a<h.largestBatchId&&(a=h.largestBatchId),s.get(l)?E.resolve():this.remoteDocumentCache.getEntry(e,l).next(f=>{u=u.insert(l,f)}))).next(()=>this.populateOverlays(e,c,s)).next(()=>this.computeViews(e,u,c,Q())).next(l=>({batchId:a,changes:Jl(l)})))})}getDocumentsMatchingDocumentQuery(e,n){return this.getDocument(e,new O(n)).next(r=>{let i=kn();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(e,n,r){const i=n.collectionGroup;let s=kn();return this.indexManager.getCollectionParents(e,i).next(o=>E.forEach(o,a=>{const u=function(c,l){return new _r(l,null,c.explicitOrderBy.slice(),c.filters.slice(),c.limit,c.limitType,c.startAt,c.endAt)}(n,a.child(i));return this.getDocumentsMatchingCollectionQuery(e,u,r).next(c=>{c.forEach((l,h)=>{s=s.insert(l,h)})})}).next(()=>s))}getDocumentsMatchingCollectionQuery(e,n,r){let i;return this.remoteDocumentCache.getAllFromCollection(e,n.path,r).next(s=>(i=s,this.documentOverlayCache.getOverlaysForCollection(e,n.path,r.largestBatchId))).next(s=>{s.forEach((a,u)=>{const c=u.getKey();i.get(c)===null&&(i=i.insert(c,Ce.newInvalidDocument(c)))});let o=kn();return i.forEach((a,u)=>{const c=s.get(a);c!==void 0&&Vn(c.mutation,u,Ke.empty(),me.now()),Ho(n,u)&&(o=o.insert(a,u))}),o})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jy{constructor(e,n,r,i,s){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.fu=[],this.du=new Map,this._u=new Set,this.wu=[],this.mu=s,this.mu.Ur(o=>{r.enqueueAndForget(async()=>{Kt(this)&&(k("RemoteStore","Restarting streams for network reachability change."),await async function(a){const u=G(a);u._u.add(4),await Rr(u),u.gu.set("Unknown"),u._u.delete(4),await Wi(u)}(this))})}),this.gu=new qy(r,i)}}async function Wi(t){if(Kt(t))for(const e of t.wu)await e(!0)}async function Rr(t){for(const e of t.wu)await e(!1)}function dh(t,e){const n=G(t);n.du.has(e.targetId)||(n.du.set(e.targetId,e),ea(n)?Zo(n):Cn(n).ko()&&Jo(n,e))}function gh(t,e){const n=G(t),r=Cn(n);n.du.delete(e),r.ko()&&mh(n,e),n.du.size===0&&(r.ko()?r.Fo():Kt(n)&&n.gu.set("Unknown"))}function Jo(t,e){t.yu.Ot(e.targetId),Cn(t).zo(e)}function mh(t,e){t.yu.Ot(e),Cn(t).Ho(e)}function Zo(t){t.yu=new Gp({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ne:e=>t.du.get(e)||null}),Cn(t).start(),t.gu.uu()}function ea(t){return Kt(t)&&!Cn(t).No()&&t.du.size>0}function Kt(t){return G(t)._u.size===0}function ph(t){t.yu=void 0}async function Gy(t){t.du.forEach((e,n)=>{Jo(t,e)})}async function zy(t,e){ph(t),ea(t)?(t.gu.hu(e),Zo(t)):t.gu.set("Unknown")}async function Hy(t,e,n){if(t.gu.set("Online"),e instanceof nh&&e.state===2&&e.cause)try{await async function(r,i){const s=i.cause;for(const o of i.targetIds)r.du.has(o)&&(await r.remoteSyncer.rejectListen(o,s),r.du.delete(o),r.yu.removeTarget(o))}(t,e)}catch(r){k("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await gi(t,r)}else if(e instanceof Hr?t.yu.Kt(e):e instanceof th?t.yu.Jt(e):t.yu.jt(e),!n.isEqual(q.min()))try{const r=await lh(t.localStore);n.compareTo(r)>=0&&await function(i,s){const o=i.yu.Zt(s);return o.targetChanges.forEach((a,u)=>{if(a.resumeToken.approximateByteSize()>0){const c=i.du.get(u);c&&i.du.set(u,c.withResumeToken(a.resumeToken,s))}}),o.targetMismatches.forEach(a=>{const u=i.du.get(a);if(!u)return;i.du.set(a,u.withResumeToken(Re.EMPTY_BYTE_STRING,u.snapshotVersion)),mh(i,a);const c=new Ft(u.target,a,1,u.sequenceNumber);Jo(i,c)}),i.remoteSyncer.applyRemoteEvent(o)}(t,n)}catch(r){k("RemoteStore","Failed to raise snapshot:",r),await gi(t,r)}}async function gi(t,e,n){if(!Cr(e))throw e;t._u.add(1),await Rr(t),t.gu.set("Offline"),n||(n=()=>lh(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{k("RemoteStore","Retrying IndexedDB access"),await n(),t._u.delete(1),await Wi(t)})}function yh(t,e){return e().catch(n=>gi(t,n,e))}async function Qi(t){const e=G(t),n=St(e);let r=e.fu.length>0?e.fu[e.fu.length-1].batchId:-1;for(;Ky(e);)try{const i=await Ly(e.localStore,r);if(i===null){e.fu.length===0&&n.Fo();break}r=i.batchId,Wy(e,i)}catch(i){await gi(e,i)}vh(e)&&Eh(e)}function Ky(t){return Kt(t)&&t.fu.length<10}function Wy(t,e){t.fu.push(e);const n=St(t);n.ko()&&n.Yo&&n.Xo(e.mutations)}function vh(t){return Kt(t)&&!St(t).No()&&t.fu.length>0}function Eh(t){St(t).start()}async function Qy(t){St(t).eu()}async function Yy(t){const e=St(t);for(const n of t.fu)e.Xo(n.mutations)}async function Xy(t,e,n){const r=t.fu.shift(),i=Wo.from(r,e,n);await yh(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await Qi(t)}async function Jy(t,e){e&&St(t).Yo&&await async function(n,r){if(i=r.code,Up(i)&&i!==p.ABORTED){const s=n.fu.shift();St(n).Mo(),await yh(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await Qi(n)}var i}(t,e),vh(t)&&Eh(t)}async function Iu(t,e){const n=G(t);n.asyncQueue.verifyOperationInProgress(),k("RemoteStore","RemoteStore received new credentials");const r=Kt(n);n._u.add(3),await Rr(n),r&&n.gu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n._u.delete(3),await Wi(n)}async function Zy(t,e){const n=G(t);e?(n._u.delete(2),await Wi(n)):e||(n._u.add(2),await Rr(n),n.gu.set("Unknown"))}function Cn(t){return t.pu||(t.pu=function(e,n,r){const i=G(e);return i.su(),new Uy(n,i.connection,i.authCredentials,i.appCheckCredentials,i.yt,r)}(t.datastore,t.asyncQueue,{Yr:Gy.bind(null,t),Zr:zy.bind(null,t),Wo:Hy.bind(null,t)}),t.wu.push(async e=>{e?(t.pu.Mo(),ea(t)?Zo(t):t.gu.set("Unknown")):(await t.pu.stop(),ph(t))})),t.pu}function St(t){return t.Iu||(t.Iu=function(e,n,r){const i=G(e);return i.su(),new By(n,i.connection,i.authCredentials,i.appCheckCredentials,i.yt,r)}(t.datastore,t.asyncQueue,{Yr:Qy.bind(null,t),Zr:Jy.bind(null,t),tu:Yy.bind(null,t),Zo:Xy.bind(null,t)}),t.wu.push(async e=>{e?(t.Iu.Mo(),await Qi(t)):(await t.Iu.stop(),t.fu.length>0&&(k("RemoteStore",`Stopping write stream with ${t.fu.length} pending writes`),t.fu=[]))})),t.Iu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
